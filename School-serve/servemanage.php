    ...
    <form method="get">
                                <table height="90%">
                                    <tr>
                                        ...
                                        <td valign="bottom" colspan="5" bgcolor="#F7F8F9"><h3 style="letter-spacing:1px;">在这里，您可以根据您的需求，修改网站参数！</h3></td>
                                    </tr>
    
                        <!-- 添加栏目开始 -->
                        <tr bgcolor="#74adaa" >
                                                        <th class="w">优惠大类型</th>
                                                        <th width="70px" class="w">优惠小类型</th>
                                                        <th width="80px" class="w">优惠时间</th>
                                                        <th width="80px" class="w">优惠地点</th>
                                                        <th width="50px" class="w">优惠规则</th>
                                                        <th width="50px" class="w">优惠宣传图片路径</th>
                                                        <th width="80px" class="w">操作</th>
													...
													$Page_size=3; 
													$result=mysqli_query($link,"select * from tb_youhui"); 
													...
													$sql="select * from tb_youhui limit $offset,$Page_size";
...
<td bgcolor="#E0EEE"><a href="shanchuserver.php?main=<?php echo $row['main'];?> & little=<?php echo $row['lujin'];?>">删除</a> &nbsp;&nbsp;
