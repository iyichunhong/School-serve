...
<body>
<form action="classroom-find-ok.php" method="get" style="width:900px; height:400px; position:absolute;"> 
...
<td bgcolor="#74adaa" colspan="3" align="left"><input type="submit" class="submit" value="查询" "/>&nbsp;&nbsp;&nbsp;&nbsp;
</td>
</tr>
</table>
</form>
