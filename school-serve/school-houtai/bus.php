   ...
   <body>
    ...
    <form method="get">
                        ...
                        <tr bgcolor="#74adaa" >
													...
													$Page_size=3; 
													$result=mysqli_query($link,"select * from tb_bus"); 
													...
													$sql="select * from tb_bus limit $offset,$Page_size";
...
<td bgcolor="#E0EEE"><a href="shanchubus.php?name=<?php echo $row['name'];?> & studentID=<?php echo $row['studentID'];?>">删除</a> &nbsp;&nbsp;
