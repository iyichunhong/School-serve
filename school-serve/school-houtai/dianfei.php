   ...
   <body>
    ...
    <form method="get">
                        ...
                        <tr bgcolor="#74adaa" >
													...
													$Page_size=3; 
													$result=mysqli_query($link,"select * from tb_power"); 
													...
													$sql="select * from tb_power limit $offset,$Page_size";
...
<td bgcolor="#E0EEE"><a href="shanchupower.php?college=<?php echo $row['college'];?> & number=<?php echo $row['number'];?>">删除</a> &nbsp;&nbsp;
</tr> 
<?php 
} 
