    ...
    <form method="get">
                                <table height="90%">
                                    <tr>
                                        ...
                                        <td valign="bottom" colspan="13" bgcolor="#F7F8F9"><h3 style="letter-spacing:1px;">在这里，您可以根据您的需求，修改网站参数！</h3></td>
                                    </tr>
                        ...
                        <tr bgcolor="#74adaa" >
                                                        ...
                                                        <th width="80px" class="w">性别</th>
                                                        <th width="50px" class="w">寝室苑</th>
                                                        <th width="70px" class="w">寝室号</th>
                                                       <th class="w">离校时间</th>
                                                       <th class="w">返校时间</th>
                                                       <th class="w">去向</th>
                                                       <th class="w">电话</th>
													...
													$Page_size=3; 
													$result=mysqli_query($link,"select * from tb_fromtheregister"); 
													...
													$sql="select * from tb_fromtheregister limit $offset,$Page_size";
...
<td bgcolor="#E0EEE"><div align="center"> 
<?php echo $row['xueyuan']?> 
</div></td>
<td bgcolor="#E0EEE"><a href="shanchuregister.php?name=<?php echo $row['name'];?> & studentID=<?php echo $row['studentID'];?>">删除</a> &nbsp;&nbsp;
...
?> 
<tr> 
<td colspan="15" bgcolor="#E0EEE0"><div align="center"><?php echo $key?></div></td> 
</tr> 
