   ...
   <body>
    ...
    <form method="get">
                        ...
                        <tr bgcolor="#74adaa" >
													...
													$Page_size=3; 
													$result=mysqli_query($link,"select * from tb_tuition"); 
													...
													$sql="select * from tb_tuition limit $offset,$Page_size";
...
<td bgcolor="#E0EEE"><a href="shanchututition.php?name=<?php echo $row['name'];?> & studentID=<?php echo $row['studentID'];?>">删除</a> &nbsp;&nbsp;
<a href="xiugai.php?name=<?php echo $row['name'];?>&college=<?php echo $row['college'];?>&sex=<?php echo $row['sex'];?>&xuewei=<?php echo $row['xuewei'];?>&xueli=<?php echo $row['xueli'];?>
&tel=<?php echo $row['tel'];?>&qq=<?php echo $row['qq'];?>&expeirnce=<?php echo $row['expeirnce'];?>">修改</a></td>
</tr> 
<?php 
} 
