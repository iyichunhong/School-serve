...
include_once 'conn/conn.php';
    ...
    while ($rs=mysqli_fetch_array($result)){ 
    	if(!$rs['reply_name'])
    		echo "<tr><td><font color=#6a6aff size=4>".$rs['username']."</font>暂时没有留言</td></tr>";
    	else{
    	?>
		...
		<a href=deleteliuyan.php?id=<?php echo $rs['studentID']?>><input class="info_reply" type="submit" value="删除" name="delete"></a><br>
    	<?php 
    	}
    }
?>
